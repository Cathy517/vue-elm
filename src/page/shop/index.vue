        ...
        <section class="food_container" v-show="changeShowType=='food'">
          ...
          <section class="buy_cart_container">
            ...
            <section class="cart_icon_num">
              <div class="cart_icon_container" ref="cartContainer" :class="{cart_icon_activity:totalPrice>0}">
            ...
            <section class="gotopay" :class="{gotopay_acitvity:minimumOrderAmount<=0}">
              ...
              <router-link class="gotopay_button_style" :to="{path:'/confirmOrder',query:{geohash,shopId}}" v-else>去结算</router-link>
            </section>
          </section>
          <!-- 购物车列表 -->
